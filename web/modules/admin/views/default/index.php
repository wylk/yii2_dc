...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="adminStatic/img/profile_small.jpg" /></span>
    ...
    <script src="adminStatic/js/jquery.min.js?v=2.1.4"></script>
    <script src="adminStatic/js/bootstrap.min.js?v=3.3.6"></script>
    <script src="adminStatic/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="adminStatic/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="adminStatic/js/plugins/layer/layer.min.js"></script>
