    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins"><?=\app\web\Helper::getHistoryVisNum()?></h1>
                    <small>访客</small>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins"><?=\app\web\Helper::getMonthHistoryVisNum()?></h1>
...
<?=Html::jsFile('@web/adminStatic/js/plugins/Highcharts/4.1.7/js/highcharts.js')?>
<?=Html::jsFile('@web/adminStatic/js/plugins/Highcharts/4.1.7/js/modules/exporting.js')?>
