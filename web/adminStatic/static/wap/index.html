...
.right-con li .btn button.minus span{background:url(img/down.png) no-repeat;background-size:22px 22px;}  
...
.right-con li .btn button.add span{background:url(img/up.png) no-repeat;background-size:22px 22px;} 
...
<!-- 第二个菜单结束 -->
		<div class="right-con">
			<ul>
				<li>
					<div class="menu-img"><img src="img/3.jpg" width="55" height="55" /></div>
					<div class="menu-txt">
						<h4>京酱肉丝</h4>
						<p class="list1">家常菜</p>
						<p class="list2">
		...
		<div class="right-con">
			<ul>
				<li>
					<div class="menu-img"><img src="img/4.jpg" width="55" height="55" /></div>
					<div class="menu-txt">
						<h4>京酱肉丝</h4>
						<p class="list1">家常菜</p>
						<p class="list2">
		...
		<div class="right-con">
			<ul>
				<li>
					<div class="menu-img"><img src="img/9.jpg" width="55" height="55" /></div>
					<div class="menu-txt">
						<h4>京酱肉丝</h4>
						<p class="list1">家常菜</p>
						<p class="list2">
