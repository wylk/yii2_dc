...
<div class="container">
   ...
   <!--  <form id="defaultForm" method="post" class="form-horizontal" action="?r=plugin/publics/default/create_company" enctype="multipart/form-data"> -->
    ...
    <input type="hidden" class="form-control" id="company_name" name="id" placeholder="公司名称" value="<?php echo $data1['id']?>">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-12">
    <input type="text" class="form-control" id="phone" name="phone" placeholder="手机号码" value="<?php echo $data1['phone']?>" style="width: 70%"><a href="javascript:;" class="btn btn-default" style="float: right;margin-top: -31px; width: 14%;" id="getCodeBtn"> 获取验证码</a>
        ...
        fields:{
            company_name:{
                ...
                validators:{
                    ...
                    threshold:4,
                    remote:{
                        url:"?r=plugin/publics/default/validate_company_name&_csrf=<?php echo \Yii::$app->request->csrfToken;?>&type=1",
                        message:"公司名称已存在",
                        delay:2000,
                        type:"GET"
                    },
