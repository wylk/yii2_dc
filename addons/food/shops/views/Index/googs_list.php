        ...
        <div id="pad-wrapper" class="users-list">
            <div class="row header">
                ...
                <div class="col-md-10 col-sm-12 col-xs-12 pull-right">
                    ...
                    <input type="text" class="col-md-5 search" placeholder="输入商品名称" name="goods_name" value="<?php echo $datasearch?>">
       ...
       $('[id=del]').click(function(){
        if(confirm('是否确定删除?')==false)
        {
          ...
          var _csrf = '<?= Yii::$app->request->csrfToken ?>';
           var id = $(this).data('id');
           $.get('?r=plugin/shops/index/do_goods_del',{id:id,_csrf:_csrf},function(re){
                 console.log(re);
                   if (re.error == 0) {
                        alert(re.msg);
