                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group clockpicker">
                                                    <input type="text" class="form-control" value="00:00" name="starttime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">至
        ...
        <script type="text/javascript">
            $(function() {
                $('#add').click(function() {
                    ...
                    console.log(data);
                    $.post('?r=plugin/shops/index/do_shop_queue_add', data,
                    function(re) {
                        console.log(re);
                        if (re.error == 0) {
                            swal({
