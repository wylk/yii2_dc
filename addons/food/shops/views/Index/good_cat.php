        ...
        <div id="pad-wrapper" class="users-list">
            <div class="row header">
                ...
                <form method="post">
                    ...
                    <a href="?r=plugin/shops/index/do_cat_add" class="btn-flat success pull-right">
                        <span>&#43;</span>
                       添加分类
                    </a>
                </div>
                      ...
                      ?>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              |
                              <a href="/?r=plugin/shops/index/do_cat_edit&cid=<?php echo $v['id']?>" onclick="if(confirm('是否确定编辑？')==false)return false;">编辑</a>
                            </td>
                        </tr>
                        <!-- row -->
                       <?php endforeach;}else{?>
    ...
    $(function(){
       $('[id=del]').click(function(){
        if(confirm('是否确定删除?')==false)
        {
           ...
           $.get('?r=plugin/shops/index/do_cat_del',{del_id:id,_csrf:_csrf},function(re){
            console.log(re);
               if (re.error == 0) {
                    alert(re.msg);
