                ...
                <div class="col-md-9 with-sidebar" style="border-right: 1px solid #fff;padding-left: 85px">
                    <div class="container">
                        <form class="new_user_form">
                            ...
                            <div class="col-md-12 field-box">
                                <label>是否开启</label>&nbsp;
                                开启：<input  type="radio" name="status" checked="checked" value="1" <?php if($employee['status'] == 1){ echo 'checked';}?>/> &nbsp;&nbsp;关闭：<input  type="radio" name="status" value='0' <?php if($employee['status'] == 0){ echo 'checked';}?>/>
                            </div>
    ...
    <script type="text/javascript">
        $(function () {
            $('#add').click(function(){
              ...
              data._csrf = _csrf;
             $.post('?r=plugin/shops/index/do_employee_edit',data,function(re){
                console.log(re);
                if (re.error == 0) {
                    alert(re.msg);
